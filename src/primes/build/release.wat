(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18020))
 (memory $0 1)
 ...
 (data (i32.const 1484) "\04\00\00\00\02")
 (data (i32.const 1500) ",")
 ...
 (data (i32.const 1600) "\04\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1628) "\02\t")
 (export "findPrimes" (func $assembly/index/findPrimes))
 ...
 (func $assembly/index/findPrimes (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
